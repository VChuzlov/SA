...
|`def func(*имя)`|Передает и собирает произвольное число позиционных аргументов в кортеж|
|`def func(**имя)`|Передает и собирает произвольное число ключевых аргументов в словарь|
