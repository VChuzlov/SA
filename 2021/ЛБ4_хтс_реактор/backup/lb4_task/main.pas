...
procedure main(feedstock_mass_flow_rate, h2_mass_flow_rate, 
...
begin
  ...
  var feedstock := new Flow(feedstock_mass_flow_rate, f_mass_frac, 
                            temperature, pressure);
  var h2 := new Flow(h2_mass_flow_rate, h2_mass_frac, temperature, pressure);
...
begin
  var (t, tk, h) := (743.15, 793.15, 5);
  for var i := 0 to Trunc((tk - t) / h) do
  begin
    println($'Температура процесса: {t}');
    main(26600, 3700, t, 0.105);
    t += h
  end;
