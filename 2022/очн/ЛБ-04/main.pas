...
begin
  ...
  he1.d_in := 0.75;
  he1.d_out := 0.9;
  var he1res := he1.calculate(hf[0], products1);
  var products1_h := he1res[1];
  ...
  he2.d_in := 0.8;
  he2.d_out := 0.95;
  var he2res := he2.calculate(hf[1], products2);
  var products2_h := he2res[1];
  ...
  he3.d_in := 0.82;
  he3.d_out := 0.97;
  var he3res := he3.calculate(hf[2], products3);
  var products3_h := he3res[1];
  
  
  var r4 := new Reactor(8.208, 3.505);
  var products4 := r4.calculate(products3_h);
  
  products4.gas_separation;
 
  products4.getRON().Println;
  products4.mass_flow_rate.Println
end.