...
procedure TFormOVofFlow.BitBtnCancelOrReadyClick(Sender: TObject);
begin
  Close; 
end;

procedure TFormOVofFlow.FormShow(Sender: TObject);
var
  i: integer;
begin
  ...
  FormOVofFlow.OD1.InitialDir:=ExtractFilePath(Application.ExeName)+'Данные';
  FormOVofFlow.SD1.InitialDir:=ExtractFilePath(Application.ExeName)+'Данные';
...
procedure TFormOVofFlow.BitBtnBackClick(Sender: TObject);
begin
...
procedure TFormOVofFlow.BitBtnForwardClick(Sender: TObject);
var
  i, j: integer;
...
procedure TFormOVofFlow.SpeedButtonInSelectFlowClick(Sender: TObject);
begin
...
procedure TFormOVofFlow.BitBtn1Click(Sender: TObject);
...
procedure TFormOVofFlow.SpeedButtonInAllFlowClick(Sender: TObject);
begin
...
procedure TFormOVofFlow.ButtonStructureClick(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
...
procedure TFormOVofFlow.ListBoxEndSelectFlowClick(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
  i: integer;
begin
...
procedure TFormOVofFlow.BitBtn2Click(Sender: TObject);
var
  i: integer;
  CountObject: integer;
  MyIniFile: TIniFile;
...
procedure TFormOVofFlow.SpeedButtonInSelectAdditiveClick(Sender: TObject);
begin
...
procedure TFormOVofFlow.SpeedButtonInAllAdditiveClick(Sender: TObject);
begin
...
procedure TFormOVofFlow.RadioButton1Click(Sender: TObject);
begin
...
procedure TFormOVofFlow.RadioButton2Click(Sender: TObject);
begin
...
procedure TFormOVofFlow.Button1Click(Sender: TObject);
var
...
procedure TFormOVofFlow.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFormOVofFlow.btCreateClick(Sender: TObject);
begin
...
procedure TFormOVofFlow.btSaveClick(Sender: TObject);
var
  i,CountObject: integer;
  MyIniFile: TIniFile;
  MyFlow: TFlowCompaunding;
...
procedure TFormOVofFlow.BitBtn4Click(Sender: TObject);
const
...
procedure TFormOVofFlow.EditExpendFlowChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormOVofFlow.EditExpendFlowKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TFormOVofFlow.ListBoxEndSelectAdditiveClick(Sender: TObject);
var
  MyAdditives: TAdditiveCompaunding;
begin
  if ListBoxEndSelectAdditive.Items.Count=0 then exit;
...
procedure TFormOVofFlow.FormCreate(Sender: TObject);
begin
  // глобальный поток
...
procedure TFormOVofFlow.Copy1Click(Sender: TObject);
begin
  (Sender as TChart).CopyToClipboardBitmap;
end;

procedure TFormOVofFlow.BtSave2Click(Sender: TObject);
var
  i, CountObject: integer;
  MyIniFile: TIniFile;
  MyFlow: TFlowCompaunding;
...
procedure TFormOVofFlow.StringGridStructureOfFlowSetEditText(
...
procedure TFormOVofFlow.N2Click(Sender: TObject);
var
  MyRow: integer;
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormOVofFlow.N1Click(Sender: TObject);
var
...
procedure TFormOVofFlow.N3Click(Sender: TObject);
var
  Comp: TComponentCompaunding;
  MyFlow: TFlowCompaunding;
  MyRow: integer;
...
procedure TFormOVofFlow.BitBtn3Click(Sender: TObject);
var
  CountObject: integer;
  MyIniFile: TIniFile;
  MyAdditives: TAdditiveCompaunding;
...
procedure TFormOVofFlow.MenuItem2Click(Sender: TObject);
var
  IndexDel: integer;
begin
...
procedure TFormOVofFlow.Button2Click(Sender: TObject);
...
procedure TFormOVofFlow.InBase1Click(Sender: TObject);
...
procedure TFormOVofFlow.GetTotalFlow(var TotalFlow: TTotalFlowCompaunding);
begin
  TotalFlow:=TotalFlowCompaunding;
end;

procedure TFormOVofFlow.EditTempFlowChange(Sender: TObject);
begin
...
procedure TFormOVofFlow.Button2Exit(Sender: TObject);
begin
  Button2.Visible:=false;
end;

procedure TFormOVofFlow.DefaultSetData;
var
  i: integer;
  R: TSearchRec;
begin
...
procedure TFormOVofFlow.Button3Click(Sender: TObject);
var
  MyIniFile: TIniFile;
  i: integer;
  Soot: double;
...
procedure TFormOVofFlow.BitBtnRVSClick(Sender: TObject);
begin
...
procedure TFormOVofFlow.EdPriceChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormOVofFlow.EdPriceKeyPress(Sender: TObject; var Key: Char);
begin
  if (not (Key in ['0'..'9', DecimalSeparator, char(8), char(#13)]))
    and (ord(Key)>25) then Key:=#0;
end;

procedure TFormOVofFlow.Button4Click(Sender: TObject);
var
  i, j: integer;
begin
  EA1.Connect;
