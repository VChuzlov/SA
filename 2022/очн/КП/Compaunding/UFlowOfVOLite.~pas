...
type
  TFormFlowOfOVLite = class(TForm)
    ...
    procedure EdAromChange(Sender: TObject);
    procedure EdBenzChange(Sender: TObject);
    procedure EdOlefChange(Sender: TObject);
    procedure EdSeraChange(Sender: TObject);
    procedure EdOVChange(Sender: TObject);
    procedure EdBsumChange(Sender: TObject);
    procedure BtSOAPClick(Sender: TObject);
  private
...
var
  FormFlowOfOVLite: TFormFlowOfOVLite;

implementation

uses USecondForm, UPravilo, UParam, UMainCompaunding, UCondition,
   UGrupp, MashaStyle1, URezervuar, UPIMS, UPlan;


{$R *.dfm}

procedure TFormFlowOfOVLite.BitBtnCancelOrReadyClick(Sender: TObject);
var
  i: integer;
begin
  ...
  begin
    ...
    TotalFlowCompaunding.Name:=IntToStr(Length(ArrTotalFlowCompaunding.Items)+1)+' день';
    ...
    FPlan.GetArrTotal(ArrTotalFlowCompaunding);
    FPlan.ShowModal;
  end;
...
procedure TFormFlowOfOVLite.FormShow(Sender: TObject);
var
  i: integer;
begin
  ...
  FormFlowOfOVLite.OD1.InitialDir:=ExtractFilePath(Application.ExeName)+'Данные';
  FormFlowOfOVLite.SD1.InitialDir:=ExtractFilePath(Application.ExeName)+'Данные';
...
procedure TFormFlowOfOVLite.BitBtnBackClick(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.BitBtnForwardClick(Sender: TObject);
var
  i, j{, multi}: integer;
...
procedure TFormFlowOfOVLite.SpeedButtonInSelectFlowClick(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.BitBtn1Click(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.SpeedButtonInAllFlowClick(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.ButtonStructureClick(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
...
procedure TFormFlowOfOVLite.ListBoxEndSelectFlowClick(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
  i: integer;
begin
  ...
  EdArom.Text:=FloatToStr(MyFlow.BigParam.Ar);
  EdBenz.Text:=FloatToStr(MyFlow.BigParam.B);
  EdOlef.Text:=FloatToStr(MyFlow.BigParam.Ol);
  EdSera.Text:=FloatToStr(MyFlow.BigParam.S);
  EdOV.Text:=FloatToStr(MyFlow.SelfOV);
  EdBsum.Text:=FloatToStr(MyFlow.Bsumar);
...
procedure TFormFlowOfOVLite.BitBtn2Click(Sender: TObject);
var
  i: integer;
  CountObject: integer;
  MyIniFile: TIniFile;
...
procedure TFormFlowOfOVLite.SpeedButtonInSelectAdditiveClick(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.SpeedButtonInAllAdditiveClick(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.RadioButton1Click(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.RadioButton2Click(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.Button1Click(Sender: TObject);
var
...
procedure TFormFlowOfOVLite.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFormFlowOfOVLite.btCreateClick(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.btSaveClick(Sender: TObject);
var
  i,CountObject: integer;
  MyIniFile: TIniFile;
  MyFlow: TFlowCompaunding;
...
procedure TFormFlowOfOVLite.BitBtn4Click(Sender: TObject);
const
...
procedure TFormFlowOfOVLite.EditExpendFlowChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormFlowOfOVLite.EditExpendFlowKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TFormFlowOfOVLite.ListBoxEndSelectAdditiveClick(Sender: TObject);
var
  MyAdditives: TAdditiveCompaunding;
begin
  if ListBoxEndSelectAdditive.Items.Count=0 then exit;
...
procedure TFormFlowOfOVLite.FormCreate(Sender: TObject);
begin
  // глобальный поток
...
procedure TFormFlowOfOVLite.Copy1Click(Sender: TObject);
begin
  (Sender as TChart).CopyToClipboardBitmap;
end;

procedure TFormFlowOfOVLite.BtInfileClick(Sender: TObject);
var
  i, CountObject: integer;
  MyIniFile: TIniFile;
  MyFlow: TFlowCompaunding;
...
procedure TFormFlowOfOVLite.StringGridStructureOfFlowSetEditText(
...
procedure TFormFlowOfOVLite.N2Click(Sender: TObject);
var
  MyRow: integer;
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormFlowOfOVLite.N1Click(Sender: TObject);
var
...
procedure TFormFlowOfOVLite.N3Click(Sender: TObject);
var
  Comp: TComponentCompaunding;
  MyFlow: TFlowCompaunding;
  MyRow: integer;
...
procedure TFormFlowOfOVLite.BitBtn3Click(Sender: TObject);
var
  CountObject: integer;
  MyIniFile: TIniFile;
  MyAdditives: TAdditiveCompaunding;
...
procedure TFormFlowOfOVLite.MenuItem4Click(Sender: TObject);
var
  IndexDel: integer;
begin
...
procedure TFormFlowOfOVLite.BtPraviloClick(Sender: TObject);
var
  i: integer;
  MyFlow: TFlowCompaunding;
  MyListBox:TListBox;
begin
  ...
  MyListBox:=((Sender as TButton).GetParentComponent.GetParentComponent.GetParentComponent.GetParentComponent.GetParentComponent.GetParentComponent as TFormFlowOfOVLite).ListBoxEndSelectFlow;
...
procedure TFormFlowOfOVLite.BtSaveAsClick(Sender: TObject);
begin
  BtSaveAs.PopupMenu.Popup(Left+Panel16.Left+BtSaveAs.Left,
    Top+160);
end;

procedure TFormFlowOfOVLite.InBase1Click(Sender: TObject);
...
procedure TFormFlowOfOVLite.GetTotalFlow(var TotalFlow: TTotalFlowCompaunding);
begin
  TotalFlow:=TotalFlowCompaunding;
end;

procedure TFormFlowOfOVLite.EditTempFlowChange(Sender: TObject);
begin
  if EditExpendFlow.Text='' then exit;
  TotalFlowCompaunding.FlowTemp:=StrToFloat(EditExpendFlow.Text);
end;

procedure TFormFlowOfOVLite.ListBoxUslovDblClick(Sender: TObject);
begin
  ListBoxUslovClick(Sender);
  Button3Click(Sender);
end;

procedure TFormFlowOfOVLite.BtSetConditionClick(Sender: TObject);
var
  Cond: TCondition;
  i: integer;
  arr: TArrOfDouble;
...
procedure TFormFlowOfOVLite.ListBoxUslovClick(Sender: TObject);
var
  Cond: TCondition;
begin
...
procedure TFormFlowOfOVLite.Button2Click(Sender: TObject);
begin
  if ListBoxUslov.ItemIndex>-1 then
  begin
...
procedure TFormFlowOfOVLite.Button3Click(Sender: TObject);
var
  Cond: TCondition;
  i: integer;
begin
...
procedure TFormFlowOfOVLite.Button4Click(Sender: TObject);
...
procedure TFormFlowOfOVLite.RadioGroup1Click(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.Button5Click(Sender: TObject);
...
procedure TFormFlowOfOVLite.DefaultSetData;  
var
  i: integer;
  R: TSearchRec;
begin
...
procedure TFormFlowOfOVLite.InBuferClick(Sender: TObject);
var
  i, j: integer;
  StrGrid: TStringGrid;
  s: string;
...
procedure TFormFlowOfOVLite.Button6Click(Sender: TObject);
var
...
procedure TFormFlowOfOVLite.RGVidDolejClick(Sender: TObject);
var
  MyFlow:TFlowCompaunding;
begin
  if ListBoxEndSelectFlow.ItemIndex>-1 then
...
procedure TFormFlowOfOVLite.BitBtnRVSClick(Sender: TObject);
begin
...
procedure TFormFlowOfOVLite.BtPIMSClick(Sender: TObject);
var
  i: integer;
...
procedure TFormFlowOfOVLite.ExportToExcelArrTotalFlow;
var
  i, j, k, n: integer;
begin
  ea1.Connect;
...
procedure TFormFlowOfOVLite.GetTotalFlowOfArr(
...
procedure TFormFlowOfOVLite.EdPriceChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormFlowOfOVLite.EdPriceKeyPress(Sender: TObject; var Key: Char);
begin
  if (not (Key in ['0'..'9', DecimalSeparator, char(8), char(#13)]))
    and (ord(Key)>25) then Key:=#0;
end;

procedure TFormFlowOfOVLite.BtNullClick(Sender: TObject);
var
  i: integer;
begin
...
procedure TFormFlowOfOVLite.EdAromChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
  if EdArom.Text='' then exit;

  if ListBoxEndSelectFlow.ItemIndex>-1 then
  begin
    MyFlow:=TotalFlowCompaunding.GetFlowOfName(
            ListBoxEndSelectFlow.Items[ListBoxEndSelectFlow.ItemIndex]);
    MyFlow.BigParam.Ar:=StrToFloat(EdArom.Text);
  end
  else
    EdArom.Text:='0';
  MyFlow.RasprBigParam;
end;

procedure TFormFlowOfOVLite.EdBenzChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
  if EdBenz.Text='' then exit;

  if ListBoxEndSelectFlow.ItemIndex>-1 then
  begin
    MyFlow:=TotalFlowCompaunding.GetFlowOfName(
            ListBoxEndSelectFlow.Items[ListBoxEndSelectFlow.ItemIndex]);
    MyFlow.BigParam.B:=StrToFloat(EdBenz.Text);
  end
  else
    EdBenz.Text:='0';
  MyFlow.RasprBigParam;
...
procedure TFormFlowOfOVLite.EdOlefChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
  if EdOlef.Text='' then exit;

  if ListBoxEndSelectFlow.ItemIndex>-1 then
  begin
    MyFlow:=TotalFlowCompaunding.GetFlowOfName(
            ListBoxEndSelectFlow.Items[ListBoxEndSelectFlow.ItemIndex]);
    MyFlow.BigParam.Ol:=StrToFloat(EdOlef.Text);
  end
  else
    EdOlef.Text:='0';
...
procedure TFormFlowOfOVLite.EdSeraChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
  if EdSera.Text='' then exit;

  if ListBoxEndSelectFlow.ItemIndex>-1 then
  begin
    MyFlow:=TotalFlowCompaunding.GetFlowOfName(
            ListBoxEndSelectFlow.Items[ListBoxEndSelectFlow.ItemIndex]);
    MyFlow.BigParam.S:=StrToFloat(EdSera.Text);
  end
  else
    EdSera.Text:='0';
  MyFlow.RasprBigParam;
...
procedure TFormFlowOfOVLite.EdOVChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
  if EdOV.Text='' then exit;

  if ListBoxEndSelectFlow.ItemIndex>-1 then
  begin
    MyFlow:=TotalFlowCompaunding.GetFlowOfName(
            ListBoxEndSelectFlow.Items[ListBoxEndSelectFlow.ItemIndex]);
    MyFlow.SelfOV:=StrToFloat(EdOV.Text);
  end
  else
    EdOV.Text:='0';
  MyFlow.RasprBigParam;
...
procedure TFormFlowOfOVLite.EdBsumChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
  if EdBsum.Text='' then exit;

  if ListBoxEndSelectFlow.ItemIndex>-1 then
  begin
    MyFlow:=TotalFlowCompaunding.GetFlowOfName(
            ListBoxEndSelectFlow.Items[ListBoxEndSelectFlow.ItemIndex]);
    MyFlow.Bsumar:=StrToFloat(EdBsum.Text);
  end
  else
    EdBsum.Text:='0';
  MyFlow.RasprBigParam;
...
procedure TFormFlowOfOVLite.BtSOAPClick(Sender: TObject);
var
  SOAPObj: TSOAPData;
  _MyFlow: TFlowCompaunding;
  i, j: integer;
begin
  SOAPObj:= TSOAPData.Create;
  SOAPObj.GetData(now);
  //по PI
  //чтобы не сработал onFormShow
  SOAP_DATA_CONNECT:=1;
  //SOAPObj.
  _ParamRezerv.SetFromSOAP(SOAPObj);
  ...
  for i:=1 to 13 do
  begin
    _MyFlow:=TotalFlowCompaunding.GetFlowOfIndexOfCondition(i);
    if _MyFlow=nil then continue;
    for j:=0 to Length(SOAPObj.ObjectQDIS)-1 do
    begin
      if SOAPObj.ObjectQDIS[j].Name=_MyFlow.NameOfCondition then
      begin
        _MyFlow.BigParam.Ar:=StrToFloat(SOAPObj.ObjectQDIS[j].ParamsQDIS[7].Value);
        _MyFlow.BigParam.B:=StrToFloat(SOAPObj.ObjectQDIS[j].ParamsQDIS[2].Value);
        _MyFlow.BigParam.Ol:=StrToFloat(SOAPObj.ObjectQDIS[j].ParamsQDIS[9].Value);
        _MyFlow.BigParam.S:=StrToFloat(SOAPObj.ObjectQDIS[j].ParamsQDIS[1].Value);
