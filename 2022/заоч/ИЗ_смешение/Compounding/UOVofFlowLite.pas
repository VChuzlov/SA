...
If NB.ActivePage='Результаты' then
  begin
     ...
     // ОЧ по упрощенному
      StringGridResult.RowCount:=StringGridResult.RowCount+1;
      StringGridResult.Cells[0,StringGridResult.RowCount-1]:='ОЧ по потокам';
      StringGridResult.Cells[1,StringGridResult.RowCount-1]:=FloatToStr(
           TotalFlowCompaunding.TotalFlowOctaneValue(true, true));
...
procedure TFormOVofFlowLite.EdAromChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormOVofFlowLite.EdBenzChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormOVofFlowLite.EdOlefChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormOVofFlowLite.EdSeraChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormOVofFlowLite.EdOVChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormOVofFlowLite.EdBsumChange(Sender: TObject);
var
  MyFlow: TFlowCompaunding;
begin
...
procedure TFormOVofFlowLite.BtSOAPClick(Sender: TObject);
var
  SOAPObj: TSOAPData;
